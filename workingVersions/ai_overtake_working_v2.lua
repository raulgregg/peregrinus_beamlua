--[[
    THIS VERSION WAS CREATED UPON THE WORK SHARED IN THE FORUM FROM FILE ai_sharedAtForum_v1.lua
    IT DOES NOT INCLUDE A OVERTAKE MANAGER AS THE LEVEL OF COMPLEXITY STARTED TO INCREASE WITH LOW RETURNS
    HENCE A RESTART FROM A NICE MILESTONE WAS REQUIRED
    CARS ARE NOT THINKING FASTER, AVOIDING WAY MORE EACH OTHER WHEN TRYING TO OVERTAKE
    HOWEVER THERE'S STILL SOME SORT OF HESITANCE ON THEM ONCE A NICE PACE HAS BEEN TAKEN BY ALL OF THEM
    WHICH IS WHERE I'LL RETAKE THE WORK
--]]
